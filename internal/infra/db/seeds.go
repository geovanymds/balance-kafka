...
func ExecSeeds(db *sql.DB) error {
	...
	statements := []string{
		...
		"INSERT INTO balances (id, account_id, value, created_at, updated_at) VALUES ('6f3a8e2f-7c0a-4d5b-b9fc-df0fb8e7fb56', 'd2b896d1-4b63-4b77-b2f2-1cbb9c17b7e0', 5000, '2023-05-10', '2023-05-10'),('a1b4e9c8-2e3f-4a7d-86c1-5d9f8a2b3b12', '8e2ec8a1-394d-4c87-83b1-8f68e4a1028f', 8000, '2023-04-22', '2023-05-10') ON DUPLICATE KEY UPDATE value=value;",
	}
